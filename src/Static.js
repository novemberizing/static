...
export default class Static {
    ...
    static async on(name) {
        ...
        if(Static.loading === null) Static.loading = new bootstrap.Modal(document.getElementById(Static.#loading), {});

        Static.view.on(await html.text(), Static.#config["index.html"], name, Static.loading, Static.controller);
        ...
        //     Static.controller.on(Static.#config["index.html"]);
        // }
