...
export default class Icon {
    static picker(onClick) {
        return novemberizing.dom.gen("div", { className: "row novemberizing bootstrap icon picker" },
            Icon.items.map(icon => novemberizing.dom.gen("div", { className: "col-1" }, novemberizing.dom.gen("i", { onClick, className: `bi bi-${icon}`})))
        );
    }
}
